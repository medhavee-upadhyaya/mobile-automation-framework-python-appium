...
class LoginPage(BasePage):
    USERNAME_FIELD = (AppiumBy.ID, "com.example.sample:id/input_username")
    PASSWORD_FIELD = (AppiumBy.ID, "com.example.sample:id/input_password")
    LOGIN_BUTTON = (AppiumBy.ID, "com.example.sample:id/button_login")
    ERROR_MESSAGE = (AppiumBy.ID, "com.example.sample:id/text_error")
